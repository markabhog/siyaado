...
export default function AudioPage() {
  ...
  const fetchAudioData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const transformedProducts: AudioProduct[] = products.map((product: any) => {
          ...
          return {
            ...
            connectivity: attributes?.connectivity || specifications?.connectivity || 'Wireless',
            batteryLife: attributes?.batteryLife || specifications?.batteryLife || '',
        ...
        setAudioProducts(transformedProducts);
      } else {
        setAudioProducts(getMockAudioProducts());
      }
    } catch (error) {
  ...
  const getMockAudioProducts = (): AudioProduct[] => [
    {
      id: '1',
    ...
    },
    {
      ...
      features: ['Waterproof', '20h Battery', '360° Sound'],
      isNew: true,
    ...
    },
    {
      ...
      type: 'Microphone',
      connectivity: 'USB-C',
      features: ['Cardioid Pattern', '48V Phantom Power', 'Low Noise'],
      isFeatured: true,
  ...
  const sortedAudioProducts = [...filteredAudioProducts].sort((a, b) => {
    switch (sortBy) {
      case 'price-low':
  ...
  const AudioProductCard = ({ product, index, viewMode }: { product: AudioProduct; index: number; viewMode: 'grid' | 'list' }) => (
    <motion.div
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600">Loading audio products...</p>
        </div>
      </div>
    );
  }
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Audio Products</h2>
              <p className="text-slate-600">High-quality audio equipment for every need</p>
            </div>
          ...
          {audioProducts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">No audio products found</h3>
              <p className="text-slate-600">Check back later for amazing audio products!</p>
            </div>
          ) : (
            <div className={viewMode === 'grid' 
              ...
              <AnimatePresence>
                {sortedAudioProducts.map((product, index) => (
                  <motion.div
                    key={product.id}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400 mb-4">
                Your trusted destination for premium audio equipment and technology products.
              </p>
            ...
            <div>
              <h4 className="font-semibold mb-4">Audio Categories</h4>
              <ul className="space-y-2 text-slate-400">
                <li><Link href="/electronics/audio" className="hover:text-white">Headphones</Link></li>
                <li><Link href="/electronics/audio" className="hover:text-white">Speakers</Link></li>
                <li><Link href="/electronics/audio" className="hover:text-white">Microphones</Link></li>
                <li><Link href="/electronics/audio" className="hover:text-white">Amplifiers</Link></li>
              </ul>
            </div>
            <div>
