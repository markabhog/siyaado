...
export default function StoragePage() {
  ...
  const fetchStorageData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const transformedProducts: StorageProduct[] = products.map((product: any) => {
        ...
        setStorageProducts(getMockStorageProducts());
      }
    } catch (error) {
  ...
  const getMockStorageProducts = (): StorageProduct[] => [
    {
      id: '1',
      title: '1TB SSD External Drive',
      price: 8999,
      originalPrice: 10999,
      images: ['/api/placeholder/300/300'],
      slug: '1tb-ssd-external-drive',
      rating: 4.8,
      reviewCount: 234,
      stock: 28,
      category: 'Storage',
      ...
      type: 'SSD',
      capacity: '1TB',
      features: ['USB 3.0', 'Fast Transfer', 'Portable'],
      isFeatured: true,
      discount: 18,
      description: 'High-speed external SSD with USB 3.0 connectivity',
      warranty: '3 years',
      color: 'Black'
    },
    {
      id: '2',
      title: '2TB HDD External Drive',
      price: 5999,
      images: ['/api/placeholder/300/300'],
      slug: '2tb-hdd-external-drive',
      rating: 4.6,
      reviewCount: 189,
      stock: 45,
      category: 'Storage',
      ...
      type: 'HDD',
      capacity: '2TB',
      features: ['USB 3.0', 'Plug & Play', 'Backup Software'],
      isNew: true,
      description: 'Reliable external hard drive for data backup and storage',
      warranty: '2 years',
      color: 'White'
    },
    {
      id: '3',
      title: '512GB USB Flash Drive',
      price: 2999,
      images: ['/api/placeholder/300/300'],
      slug: '512gb-usb-flash-drive',
      rating: 4.7,
      reviewCount: 156,
      stock: 67,
      category: 'Storage',
      ...
      type: 'USB',
      capacity: '512GB',
      features: ['USB 3.2', 'Compact', 'High Speed'],
      isFeatured: true,
      description: 'Compact USB flash drive with high-speed data transfer',
      warranty: '1 year',
      color: 'Blue'
    }
  ];

  const filteredStorageProducts = storageProducts.filter(product => {
  ...
  const sortedStorageProducts = [...filteredStorageProducts].sort((a, b) => {
    switch (sortBy) {
      case 'price-low':
  ...
  const StorageProductCard = ({ product, index, viewMode }: { product: StorageProduct; index: number; viewMode: 'grid' | 'list' }) => (
    <motion.div
      ...
      <div className="p-4">
        <div className="mb-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-slate-500">{product.capacity}</span>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600">Loading storage products...</p>
        </div>
      </div>
    );
  }
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Storage Solutions</h2>
              <p className="text-slate-600">Reliable data storage for all your needs</p>
            </div>
          ...
          {storageProducts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">No storage products found</h3>
              <p className="text-slate-600">Check back later for amazing storage solutions!</p>
            </div>
          ) : (
            <div className={viewMode === 'grid' 
              ...
              <AnimatePresence>
                {sortedStorageProducts.map((product, index) => (
                  <motion.div
                    key={product.id}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400 mb-4">
                Your trusted destination for reliable storage solutions and data management.
              </p>
            ...
            <div>
              <h4 className="font-semibold mb-4">Storage Categories</h4>
              <ul className="space-y-2 text-slate-400">
                <li><Link href="/electronics/storage" className="hover:text-white">SSD Drives</Link></li>
                <li><Link href="/electronics/storage" className="hover:text-white">HDD Drives</Link></li>
                <li><Link href="/electronics/storage" className="hover:text-white">USB Drives</Link></li>
                <li><Link href="/electronics/storage" className="hover:text-white">Memory Cards</Link></li>
              </ul>
            </div>
            <div>
