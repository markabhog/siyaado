...
export default function AccessoriesPage() {
  ...
  const fetchAccessoryData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const transformedProducts: AccessoryProduct[] = products.map((product: any) => {
          ...
          return {
            ...
            type: attributes?.type || 'Accessory',
        ...
        setAccessoryProducts(transformedProducts);
      } else {
        setAccessoryProducts(getMockAccessoryProducts());
      }
    } catch (error) {
  ...
  const getMockAccessoryProducts = (): AccessoryProduct[] => [
    {
      id: '1',
      ...
      features: ['Fast Charging', 'LED Indicator', 'Anti-Slip'],
      isFeatured: true,
      discount: 25,
    ...
    },
    {
      ...
      features: ['Adjustable Height', 'Ventilation', 'Portable'],
      isNew: true,
    ...
    },
    {
      ...
      features: ['HDMI', 'USB 3.0', 'SD Card Reader'],
      isFeatured: true,
  ...
  const sortedAccessoryProducts = [...filteredAccessoryProducts].sort((a, b) => {
    switch (sortBy) {
      case 'price-low':
  ...
  const AccessoryProductCard = ({ product, index, viewMode }: { product: AccessoryProduct; index: number; viewMode: 'grid' | 'list' }) => (
    <motion.div
      ...
      <div className="p-4">
        <div className="mb-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-slate-500">{product.compatibility}</span>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600">Loading accessories...</p>
        </div>
      </div>
    );
  }
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Accessories</h2>
              <p className="text-slate-600">Essential accessories for your devices</p>
            </div>
          ...
          {accessoryProducts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">No accessories found</h3>
              <p className="text-slate-600">Check back later for amazing accessories!</p>
            </div>
          ) : (
            <div className={'grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'}>
              <AnimatePresence>
                {sortedAccessoryProducts.map((product, index) => (
                  <motion.div
                    key={product.id}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400 mb-4">
                Your trusted destination for premium tech accessories and electronic products.
              </p>
            ...
            <div>
              <h4 className="font-semibold mb-4">Accessory Categories</h4>
              <ul className="space-y-2 text-slate-400">
                <li><Link href="/electronics/accessories" className="hover:text-white">Chargers</Link></li>
                <li><Link href="/electronics/accessories" className="hover:text-white">Stands</Link></li>
                <li><Link href="/electronics/accessories" className="hover:text-white">Hubs</Link></li>
                <li><Link href="/electronics/accessories" className="hover:text-white">Cases</Link></li>
              </ul>
            </div>
            <div>
